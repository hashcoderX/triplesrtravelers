            ...
            <div class="row maingap">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card h-100 shadow-sm tripmainbox" style="border-radius: 20px; overflow: hidden;">
                        <img src="{{ asset($trip->firstImage->file_url ?? 'images/default-trip.jpg') }}"
                        ...
                        <div class="tripsmintro">{{ \Illuminate\Support\Str::limit($trip->content, 100, '...') }}</div>
                        <div class="pricerequest-box">
                            Price on request
                        </div>

                        <a class="moredetailsbtn" href="/fr/exploretrip/{{ $trip->id }}">More Detail</a>
                    </div>
                </div>
                @endforeach
            </div>
