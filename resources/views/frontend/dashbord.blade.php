                ...
                <div class="inner-content">
                    <div class="row align-items-center clearfix">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-column">
                            <a href="/getservicerecord/{{ $vehicle->cus_id }}/{{ $vehicle->id }}">
                                <div class="form-inner">
                                    <h3 style="text-align: center;">{{ $vehicle->vehicleno  }}</h3>
                                    <p style="text-align: center;">{{ $vehicle->brand .' '.$vehicle->vehiclemodel  }}</p>
                                </div>
                            </a>
                        </div>
                        @endforeach
