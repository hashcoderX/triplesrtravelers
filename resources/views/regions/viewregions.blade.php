                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Region Images</h4>
                                                ...
                                                <div class="owl-stage-outer">
                                                    <div class="owl-stage" style="transform: translate3d(-1445px, 0px, 0px); transition: all 0.25s ease 0s; width: 3374px;">
                                                        ...
                                                        <div class="owl-item cloned" style="width: 471.984px; margin-right: 10px;">
                                                            <div class="item">
                                                                <img src="{{ asset($regionImage->file_url) }}" alt="">
                                                            </div>
                                                        </div>
                                                        @endforeach
                                                    </div>
                                                ...
                                                <div class="preview-item-content d-flex flex-grow">
                                                    <div class="flex-grow">
                                                        <div class="d-flex d-md-block d-xl-flex justify-content-between">
                                                            <h6 class="preview-subject" id="vehiclenox">{{ $region->topic }}</h6>

                                                            <p class="text-muted text-small" id="regionid" style="display: none;">{{ $region->id }}</p>
                                                        </div>
                                                        <p class="text-muted">{{ $region->content }}</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="contact-form-validated form-one"
                    action="/uploadregionimages"
                    method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="exampleInputUsername1">Region ID <span class="acspan">*</span></label>
                        <input type="text" class="form-control" id="regionsid" name="regionsid" style="color: gray;" placeholder="Trip ID" value="{{ $region->id }}">
                    </div>
