                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Trip Images</h4>
                                                ...
                                                <div class="owl-stage-outer">
                                                    <div class="owl-stage" style="transform: translate3d(-1445px, 0px, 0px); transition: all 0.25s ease 0s; width: 3374px;">
                                                        ...
                                                        <div class="owl-item cloned" style="width: 471.984px; margin-right: 10px;">
                                                            <div class="item">
                                                                <img src="{{ asset($tripImage->file_url) }}" alt="">
                                                            </div>
                                                        </div>
                                                        @endforeach
                                                    </div>
                                                ...
                                                <div class="preview-item-content d-flex flex-grow">
                                                    <div class="flex-grow">
                                                        <div class="d-flex d-md-block d-xl-flex justify-content-between">
                                                            <h6 class="preview-subject" id="vehiclenox">{{ $trip->name }}</h6>

                                                            <p class="text-muted text-small" id="tripid" style="display: none;">{{ $trip->id }}</p>
                                                        </div>
                                                        <p class="text-muted">{{ $trip->type }}</p>
                                                        <p class="text-muted">Start Date - {{ $trip->start_date }} / End Date - {{ $trip->end_date }}</p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="contact-form-validated form-one"
                    action="/uploadtripimages"
                    method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="exampleInputUsername1">Trip ID <span class="acspan">*</span></label>
                        <input type="text" class="form-control" id="tripid" name="tripid" style="color: gray;" placeholder="Trip ID" value="{{ $trip->id }}">
                    </div>
